<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <!-- Search Header -->
    <div
      class="sticky top-0 z-40 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800"
    >
      <div class="p-4">
        <div class="relative">
          <UInput
    ...
    <div class="p-4">
          ...
          >
            <div class="text-white">
              ...
              <p class="text-xs opacity-80">
                {{ formatCount(tag.count) }} {{ $t("social.posts") }}
              </p>
            </div>
          </NuxtLink>
        </div>
      ...
      <!-- Suggested Users -->
      <section
        v-if="activeCategory === 'all' || activeCategory === 'people'"
        class="mb-8"
      >
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-lg font-bold text-gray-900 dark:text-white">
      ...
      <section v-if="activeCategory === 'all' || activeCategory === 'trending'">
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex gap-2">
            <button
              :class="
                gridView === 'grid' ? 'text-primary-500' : 'text-gray-400'
              "
              @click="gridView = 'grid'"
            >
            ...
            <button
              :class="
                gridView === 'large' ? 'text-primary-500' : 'text-gray-400'
              "
        ...
        >
          ...
          >
            ...
            <div v-if="item.imageCount > 1" class="absolute top-2 right-2">
              <Icon
                name="heroicons:squares-2x2-solid"
            ...
            <!-- Stats overlay -->
            <div
              class="absolute inset-0 bg-black/0 hover:bg-black/40 transition-colors flex items-center justify-center opacity-0 hover:opacity-100"
            >
              <div class="flex gap-4 text-white">
                ...
                <div class="flex items-center gap-1">
                  <Icon
                    name="heroicons:chat-bubble-left-solid"
                    class="w-5 h-5"
                  />
                  <span class="font-semibold">{{
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div class="absolute top-2 left-2 flex items-center gap-2">
              <span
                class="px-2 py-0.5 bg-red-500 text-white text-xs font-bold rounded"
                >LIVE</span
              >
        ...
        <div class="space-y-4">
          ...
          >
            <div class="flex gap-4">
              <div
                class="text-center bg-primary-50 dark:bg-primary-900/30 rounded-lg p-3 min-w-[60px]"
              >
                <p
...
const upcomingEvents = ref([
  {
    ...
    location: "Miami, FL",
    attendees: [
      { pubkey: "1", picture: "https://i.pravatar.cc/150?u=20" },
      { pubkey: "2", picture: "https://i.pravatar.cc/150?u=21" },
      { pubkey: "3", picture: "https://i.pravatar.cc/150?u=22" },
      { pubkey: "4", picture: "" },
    ],
  },
  {
    ...
    location: "Online",
    attendees: [
      { pubkey: "1", picture: "https://i.pravatar.cc/150?u=23" },
      { pubkey: "2", picture: "https://i.pravatar.cc/150?u=24" },
    ],
  },
]);
...
const refreshSuggestions = () => {
  // Shuffle suggestions
  suggestedUsers.value = [...suggestedUsers.value].sort(
    () => Math.random() - 0.5,
  );
};
