<template>
  <div
    class="min-h-screen bg-gray-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-black dark:to-gray-900"
  >
    <!-- Desktop Layout -->
    <div class="hidden lg:flex h-screen">
      <!-- Left Panel - Tools -->
      <div
        class="w-80 bg-white dark:bg-gray-900/50 border-r border-gray-200 dark:border-gray-800 flex flex-col"
      >
        <!-- Header -->
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div class="space-y-3">
            ...
            <div class="grid grid-cols-2 gap-3">
              <button class="desktop-tool-card" @click="openMediaPicker">
                <div
                  class="tool-icon-lg bg-gradient-to-br from-pink-500 to-orange-400"
                >
              ...
              <button class="desktop-tool-card" @click="openCamera">
                <div
                  class="tool-icon-lg bg-gradient-to-br from-blue-500 to-cyan-400"
                >
          ...
          <div class="space-y-3">
            ...
            <div class="flex gap-2 flex-wrap">
              <button
                ...
                :class="
                  textColor === color
                    ? 'border-primary-500 dark:border-white scale-110'
            ...
            <div class="flex gap-2 flex-wrap">
              <button
                ...
                "
                :style="{
                  backgroundColor: bg.value === 'transparent' ? '' : bg.value,
                }"
                @click="textBgColor = bg.value"
              >
                <Icon
                  v-if="bg.value === 'transparent'"
        ...
        <!-- Caption & Post -->
        <div
          class="p-4 border-t border-gray-200 dark:border-gray-800 space-y-4"
        >
          <UTextarea
            v-model="caption"
      ...
      <div
        class="flex-1 flex items-center justify-center p-8 bg-gray-100 dark:bg-black/30"
      >
        <div class="relative">
          <!-- Phone Frame -->
          <div
            class="relative w-[320px] h-[640px] bg-gray-200 dark:bg-gray-900 rounded-[3rem] p-3 shadow-2xl border-4 border-gray-300 dark:border-gray-800"
          >
            <!-- Notch -->
            <div
              class="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-7 bg-gray-200 dark:bg-gray-900 rounded-b-2xl z-10"
            />

            <!-- Story Content -->
            <div
              class="relative w-full h-full bg-gray-300 dark:bg-gray-800 rounded-[2.25rem] overflow-hidden"
            >
              <!-- Media Preview -->
              ...
              <div
                v-else
                class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-900"
              >
                <div class="text-center p-6">
                  <div
                    class="w-16 h-16 mx-auto mb-4 bg-gray-300 dark:bg-gray-600/50 rounded-full flex items-center justify-center"
                  >
                    <Icon
              ...
              <div
                class="absolute top-4 left-4 right-12 flex items-center gap-2 z-10"
              >
                <div
      ...
      <!-- Right Panel - Tips -->
      <div
        class="w-72 bg-white dark:bg-gray-900/30 border-l border-gray-200 dark:border-gray-800 p-6 hidden xl:block"
      >
        ...
        <div class="space-y-4">
          <div class="flex gap-3 text-sm">
            <div
              class="w-8 h-8 rounded-full bg-primary-100 dark:bg-primary-500/20 flex items-center justify-center flex-shrink-0"
            >
              <Icon
            ...
            <p class="text-gray-600 dark:text-gray-400">
              Stories disappear after 24 hours, perfect for casual moments!
            </p>
          </div>
          <div class="flex gap-3 text-sm">
            <div
              class="w-8 h-8 rounded-full bg-pink-100 dark:bg-pink-500/20 flex items-center justify-center flex-shrink-0"
            >
              <Icon
            ...
            <p class="text-gray-600 dark:text-gray-400">
              Add stickers and text to make your story more engaging
            </p>
          </div>
          <div class="flex gap-3 text-sm">
            <div
              class="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center flex-shrink-0"
            >
              <Icon
                name="heroicons:photo"
            ...
            <p class="text-gray-600 dark:text-gray-400">
              Use filters to enhance your photos with one tap
            </p>
          </div>
          <div class="flex gap-3 text-sm">
            <div
              class="w-8 h-8 rounded-full bg-yellow-100 dark:bg-yellow-500/20 flex items-center justify-center flex-shrink-0"
            >
              <Icon
                name="heroicons:bolt"
            ...
            <p class="text-gray-600 dark:text-gray-400">
              Your followers will see your story at the top of their feed
            </p>
          </div>
        </div>
        ...
        <div class="mt-8">
          ...
          <div class="space-y-2 text-xs">
            <div class="flex justify-between text-gray-500 dark:text-gray-400">
              ...
              <kbd
                class="px-2 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-gray-600 dark:text-gray-300"
                >⌘ + Enter</kbd
              >
            </div>
            <div class="flex justify-between text-gray-500 dark:text-gray-400">
    ...
    <div class="lg:hidden min-h-screen flex flex-col">
      <!-- Header -->
      <div
        class="sticky top-0 z-40 flex items-center justify-between p-4 bg-white/80 dark:bg-black/80 backdrop-blur-lg border-b border-gray-200 dark:border-transparent"
      >
        <UButton
      ...
      <!-- Story Preview -->
      <div
        class="flex-1 flex items-center justify-center p-4 bg-gray-100 dark:bg-transparent"
      >
        <div
          class="relative aspect-[9/16] w-full max-w-sm bg-gray-200 dark:bg-gray-900 overflow-hidden rounded-2xl shadow-lg"
        >
          <!-- Media Preview -->
          <div v-if="selectedMedia" class="absolute inset-0">
            <video
          ...
          >
            <div class="text-center p-8">
              <div
                class="w-20 h-20 mx-auto mb-4 bg-gray-200 dark:bg-gray-700/50 rounded-full flex items-center justify-center"
              >
      ...
      <!-- Tools Panel -->
      <div
        class="bg-white dark:bg-black/90 backdrop-blur-lg p-4 space-y-4 pb-8 border-t border-gray-200 dark:border-gray-800"
      >
        <!-- Caption Input -->
        ...
        <div class="flex justify-around">
          <button class="tool-btn" @click="openMediaPicker">
            <div
              class="tool-icon bg-gradient-to-br from-pink-500 to-orange-400"
            >
          ...
          <button class="tool-btn" @click="showTextEditor = true">
            <div
              class="tool-icon bg-gradient-to-br from-purple-500 to-pink-400"
            >
          ...
          <button class="tool-btn" @click="showStickers = true">
            <div
              class="tool-icon bg-gradient-to-br from-yellow-500 to-orange-400"
            >
          ...
          >
            <div
              class="tool-icon bg-gradient-to-br from-green-500 to-teal-400"
              :class="{ 'opacity-50': !selectedMedia }"
            >
          ...
          <div class="flex gap-3 overflow-x-auto pb-2">
            ...
            >
              ...
              >
                ...
                <div
                  v-else
                  class="w-full h-full bg-gradient-to-br from-purple-500 to-pink-500"
                  :style="{ filter: filter.css }"
                />
              </div>
...
const currentStickers = computed(() => {
  return (
    stickerCategories.find((c) => c.name === selectedStickerCat.value)
      ?.stickers || []
  );
});
...
// SEO
useHead({
  title: "Create Story | BitOS Space",
});
</script>
