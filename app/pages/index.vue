    ...
    <section class="py-20 bg-white dark:bg-gray-900">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <!-- Feature 1: Shorts -->
          <div
            class="text-center p-6 rounded-2xl bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20"
          >
            <div
              class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center"
            >
          ...
          <!-- Feature 2: Nostr -->
          <div
            class="text-center p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20"
          >
            <div
              class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center"
            >
          ...
          <!-- Feature 3: Bitcoin -->
          <div
            class="text-center p-6 rounded-2xl bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20"
          >
            <div
              class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 flex items-center justify-center"
            >
              <Icon
    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-800">
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between mb-8">
          ...
          <NuxtLink
            to="/discover"
            class="text-primary-500 hover:text-primary-600 flex items-center gap-1"
          >
            {{ $t("common.view_all") }}
...
useHead({
  title: "BitOS Space - Decentralized Social on Nostr",
});
</script>
